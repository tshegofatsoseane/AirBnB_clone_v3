...
All errors printed in `STDERR`

Return:
Exit status is number of errors, 0 if Success
...
def __analyse(file_path):
    """Analyse file and print the result
    """
    nb_errors = 0
    try:
        result = None
...
def __files_loop():
    """Loop to analyse each file from input args
    """
    nb_errors = 0
...
if __name__ == "__main__":
    ...
    """Exit after executing tests. Exit status = Number of errors (0 on success)
    """
